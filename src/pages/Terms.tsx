                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-muted-foreground text-lg border-l-2 border-primary/40 pl-4 uppercase tracking-[0.2em] font-bold mb-10">
                            Última actualização: 7 de Fevereiro de 2026
                        </p>
                    ...
                    <div className="space-y-10">
                        ...
                        >
                            ...
                            <p className="text-muted-foreground text-lg leading-relaxed">
                                Você é responsável por manter a confidencialidade da sua conta e senha. Qualquer atividade realizada através da sua conta será de sua inteira responsabilidade. É proibido o uso de contas falsas, bots ou qualquer ferramenta automatizada para interagir com o sistema.
                            </p>
                        </motion.section>
                        ...
                        >
                            ...
                            <div className="space-y-6 text-muted-foreground text-lg leading-relaxed">
                                ...
                                <p className="flex gap-3">
                                    <span className="text-primary font-black">•</span>
                                    <span>Clientes devem enviar comprovativos válidos de transferência ou Multicaixa Express via WhatsApp para activação de campanhas.</span>
                                </p>
                                <p className="flex gap-3">
                                    <span className="text-primary font-black">•</span>
                            ...
                            <div className="space-y-6 text-muted-foreground text-lg leading-relaxed">
                                ...
                                <ul className="space-y-3">
                                    <li className="flex gap-3 text-sm">
                                        ...
                                        <span><strong>Transparência:</strong> Nunca compartilhamos os seus contactos de WhatsApp ou Email com terceiros.</span>
                                    </li>
                                    <li className="flex gap-3 text-sm">
                                        <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2" />
                        ...
                        >
                            ...
                            <p className="text-muted-foreground text-lg leading-relaxed">
                                Utilizamos cookies essenciais para manter a sua sessão activa e garantir que você não precise fazer login repetidamente. Cookies de terceiros podem ser usados de forma anônima para melhorar a performance do site em Angola e em outros países lusófonos.
                            </p>
                        </motion.section>
