      ...
      <div className="container-app relative z-10 py-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-lime mb-8 animate-fade-in">
            ...
            <span className="text-sm font-medium text-primary">Plataforma de Crescimento Social #1 em Angola</span>
          </div>
          ...
          {/* Warning Banner */}
          <div className="glass border border-destructive/30 rounded-xl p-6 max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: "0.4s" }}>
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-4 sm:gap-8 max-w-2xl mx-auto mt-16 animate-fade-in" style={{ animationDelay: "0.5s" }}>
            {[
              { value: "10K+", label: "Campanhas" },
              { value: "50K+", label: "Trabalhadores" },
              { value: "100M+ Kz", label: "Pagos" },
            ].map((stat, i) => (
