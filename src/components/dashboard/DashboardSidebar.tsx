...
const DashboardSidebar = ({ userType, activeSection, onSectionChange }: DashboardSidebarProps) => {
  ...
  const menuItems = userType === "client" 
    ? [
        ...
        { id: "criar-campanha", label: "Criar Campanha", icon: Plus },
  ...
  return (
    <>
      ...
      {/* Mobile sidebar */}
      <aside className={`lg:hidden fixed left-0 top-0 h-full w-64 bg-card border-r border-border z-50 transform transition-transform ${
