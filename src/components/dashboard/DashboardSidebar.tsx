...
import { LayoutDashboard, Bell, LogOut, Plus, Wallet, CheckCircle, Settings, Menu, X, MessageSquare, Gift } from "lucide-react";
...
const DashboardSidebar = ({
  ...
  const menuItems = userType === "client" ? [{
    ...
    icon: MessageSquare // I need to import this
  }];
