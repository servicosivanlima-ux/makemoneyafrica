    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-black font-display text-white uppercase tracking-widest">Gerenciar Depósitos</h2>
                            ...
                            {deposits.length === 0 ? (
                                ...
                                deposits.map((deposit) => (
                                    <tr key={deposit.id} className="hover:bg-white/[0.02] transition-colors group">
                                        <td className="p-4">
                                            <div className="font-bold text-white">{deposit.profiles?.full_name || "Usuário"}</div>
