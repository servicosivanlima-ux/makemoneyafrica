                    ...
                    <table className="w-full">
                        <thead className="bg-white/5">
                            <tr>
                                ...
                                <th className="text-right px-4 py-3 text-[10px] font-black text-muted-foreground uppercase tracking-wider">Ações</th>
                            </tr>
                        </thead>
                    ...
                    {selectedCampaign && (
                        <div className="space-y-4 pt-4">
                            <div className="grid grid-cols-1 gap-4">
                                ...
                                <div className="p-4 rounded-xl bg-white/5 space-y-1">
                                    <p className="text-[10px] text-muted-foreground uppercase font-black tracking-widest">Status Atual</p>
