...
const ChatModeration = () => {
    ...
    const toggleModeration = async (userId: string, action: 'unban' | 'mute' | 'ban') => {
        try {
            ...
            toast.success(`Utilizador atualizado: ${action}`);
            loadModeratedUsers();
        } catch (error: any) {
                        ...
                        <table className="w-full">
                            <thead className="bg-white/5">
                                <tr>
                                    ...
                                    <th className="text-right px-6 py-4 text-[10px] font-black text-muted-foreground uppercase tracking-widest">Ações</th>
                                </tr>
                            </thead>
                                        ...
                                        <tr key={u.id} className="hover:bg-white/5 transition-colors">
                                            ...
                                            <td className="px-6 py-4">
                                                {u.is_banned ? (
                                                    ...
                                                    <Badge className="bg-green-500/10 text-green-500 border-green-500/20 text-[8px] font-black uppercase px-2">ATIVO</Badge>
                                                )}
                                            </td>
                                            <td className="px-6 py-4">
