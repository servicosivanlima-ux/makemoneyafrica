...
const NotificationsManager = () => {
    ...
    const handleSend = async () => {
        ...
        if (targetType === "specific" && !specificEmail.trim()) {
            toast.error("Digite o email do utilizador");
            return;
        }
        ...
        try {
            ...
            if (userIds.length === 0) {
                toast.warning("Nenhum utilizador encontrado para este grupo");
                return;
            }
            ...
            toast.success(`Notificação enviada para ${userIds.length} utilizador(es)!`);
            setTitle("");
            setMessage("");
            setLink("");
            setSpecificEmail("");
            ...
            <div className="card-elevated p-6 space-y-4">
                {targetType === "specific" && (
                    <div className="space-y-2">
                        <label className="text-xs font-black uppercase tracking-wider text-muted-foreground">Email do Utilizador</label>
                        <Input
                            value={specificEmail}
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-[10px] text-muted-foreground italic">
                        *Para funcionar o clique, certifique-se que o utilizador rodou o comando SQL para adicionar a coluna 'link'.
                    </p>
                </div>
