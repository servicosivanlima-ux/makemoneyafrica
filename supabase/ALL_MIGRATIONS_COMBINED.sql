...
BEGIN
  ...
  v_reward_amount := CASE WHEN v_campaign.plan_type = 'ta_no_limao' THEN 100 ELSE 600 END;
...
-- ============================================
- -   = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =  
 - -   R E F U N D   O N   C A M P A I G N   D E L E T E   ( A D M I N   O N L Y )  
 - -   = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =  
  
 C R E A T E   O R   R E P L A C E   F U N C T I O N   p u b l i c . r e f u n d _ c a m p a i g n _ o n _ d e l e t e ( )  
 R E T U R N S   T R I G G E R   A S   $ $  
 D E C L A R E  
     v _ i s _ a d m i n   b o o l e a n ;  
 B E G I N  
     - -   C h e c k   i f   e x e c u t e d   b y   a d m i n  
     v _ i s _ a d m i n   : =   p u b l i c . h a s _ r o l e ( a u t h . u i d ( ) ,   ' a d m i n ' : : a p p _ r o l e ) ;  
      
     - -   O n l y   r e f u n d   i f :  
     - -   1 .   U s e r   i s   A d m i n  
     - -   2 .   C a m p a i g n   w a s   A c t i v e   ( m e a n i n g   i t   w a s   p a i d   f o r )  
     - -   3 .   N o   t a s k s   w e r e   c o m p l e t e d   ( c o m p l e t e d _ c o u n t   =   0 )  
     I F   v _ i s _ a d m i n   A N D   O L D . s t a t u s   =   ' a c t i v e '   A N D   O L D . c o m p l e t e d _ c o u n t   =   0   T H E N  
         U P D A T E   p u b l i c . p r o f i l e s  
         S E T   w a l l e t _ b a l a n c e   =   w a l l e t _ b a l a n c e   +   O L D . p r i c e  
         W H E R E   u s e r _ i d   =   O L D . c l i e n t _ i d ;  
     E N D   I F ;  
  
     R E T U R N   O L D ;  
 E N D ;  
...
  
 - -   D r o p   t r i g g e r   i f   e x i s t s   t o   a l l o w   s a f e   r e - r u n s  
 D R O P   T R I G G E R   I F   E X I S T S   o n _ c a m p a i g n _ d e l e t e _ r e f u n d   O N   p u b l i c . c a m p a i g n s ;  
  
 C R E A T E   T R I G G E R   o n _ c a m p a i g n _ d e l e t e _ r e f u n d  
 B E F O R E   D E L E T E   O N   p u b l i c . c a m p a i g n s  
 F O R   E A C H   R O W  
 E X E C U T E   F U N C T I O N   p u b l i c . r e f u n d _ c a m p a i g n _ o n _ d e l e t e ( ) ;  
 