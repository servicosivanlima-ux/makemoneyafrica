-- ============================================
-- FIX: Adicionar ENUMs e Tabelas em falta
-- A tabela 'profiles' já existe
-- ============================================
...
-- 7. Criar tabela blocked_devices
...
-- 13. Políticas RLS para campaigns
...
-- 15. Políticas RLS para withdrawals
...
-- 16. Políticas RLS para notifications
...
-- 17. Políticas RLS para blocked_devices
...
-- 23. Storage bucket (ignorar erro se já existir)
...
-- 25. Função create_campaign_secure (COM payment_proof_url)
