...
BEGIN
  ...
  INSERT INTO public.profiles (
    user_id, full_name, email, phone, user_type,
    account_type, company_name, withdrawal_method, withdrawal_details,
  ...
  ELSE
    -- Garante que se for admin em metadados mas não for o primeiro, vira cliente por segurança
    -- (Opcional, mas aqui vamos seguir o tipo solicitado exceto o primeiro que sempre é admin)
